/*
 File: coal.cpp
 Author: Aaron Barlow
 Purpose: To calculate how much energy coal produces
*/
...
int main() {
	...
	while( true ) {
		...
		// Ask user for percent of carbon
		cout << "Please enter percent of carbon (0 to end):";
		cin >> carbon;

		// Exit program when carbon is 0
		if ( carbon == 0 ) {
			break;
		}
		...
		// Ensure that total percent are less than or equal to 100
